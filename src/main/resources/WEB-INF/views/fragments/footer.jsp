...
<acme:footer-panel>
	...
	<acme:footer-subpanel code="master.footer.title.about">
		...
		<acme:footer-option icon="fa fa-info-circle" code="master.footer.label.company" action="/any/system/company"/>
		<acme:footer-option icon="fa fa-balance-scale" code="master.footer.label.license" action="/any/system/license"/>
