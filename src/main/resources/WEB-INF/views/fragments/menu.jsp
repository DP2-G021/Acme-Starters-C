	...
	<acme:menu-left>
		...
		<acme:menu-option code="master.menu.any">
			<acme:menu-suboption code="master.menu.any.list-campaigns"
				action="/any/campaign/list" />
			<acme:menu-suboption code="master.menu.any.list-strategies"
				action="/any/strategy/list" />
			<acme:menu-suboption code="master.menu.any.list-inventions"
				action="/any/invention/list" />
			<acme:menu-suboption code="master.menu.any.list-strategies"
				action="/any/strategy/list" />
			<acme:menu-suboption code="master.menu.any.list-sponsorship"
				action="/any/sponsorship/list" />
			<acme:menu-suboption code="master.menu.any.auditreport"
				action="/any/audit-report/list" />
		...
		<acme:menu-option code="master.menu.auditor"
			access="hasRealm('Auditor')">
			<acme:menu-suboption code="master.menu.auditor.list-my-audit-reports"
				action="/authenticated/audit-report/list" />
		</acme:menu-option>
		...
		<acme:menu-option code="master.menu.fundraiser"
			access="hasRealm('Fundraiser')">
			<acme:menu-suboption code="master.menu.fundraiser.list-my-strategies"
				action="/authenticated/strategy/list" />
		</acme:menu-option>


		<acme:menu-option code="master.menu.spokesperson"
			access="hasRealm('Spokesperson')">
			<acme:menu-suboption
				code="master.menu.spokesperson.list-my-campaigns"
				action="/authenticated/campaign/list" />
		</acme:menu-option>

		<acme:menu-option code="master.menu.inventor"
			access="hasRealm('Inventor')">
	...
	<acme:menu-right>
		...
		<acme:menu-option code="master.menu.user-account"
			...
			<acme:menu-suboption code="master.menu.user-account.consumer-profile"
				...
				access="hasRealm('Consumer')" />
			<acme:menu-separator />
        	<acme:menu-suboption code="master.menu.user-account.become-spokesperson"
            	action="/authenticated/spokesperson/create"
            	access="!hasRealm('Spokesperson')" />
        	<acme:menu-suboption code="master.menu.user-account.spokesperson-profile"
            	action="/authenticated/spokesperson/update"
            	access="hasRealm('Spokesperson')" />
		</acme:menu-option>
	</acme:menu-right>
</acme:menu-bar>